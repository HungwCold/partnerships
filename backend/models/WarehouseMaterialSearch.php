...
/**
 * WarehouseMaterialSearch represents the model behind the search form of `app\models\WarehouseMaterial`.
 */
class WarehouseMaterialSearch extends WarehouseMaterial
{
    /**
     * {@inheritdoc}
     */
